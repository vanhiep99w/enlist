  ...
  return (
    ...
    >
      ...
      <g className={animated ? 'float' : ''}>
        ...
        <path d="M56 12 L72 12 L42 68 L26 68 Z" fill="url(#accentGradient)" filter="url(#glow)" />
    ...
    >
      ...
      <g className={animated ? 'breathe' : ''}>
        ...
        <g className={animated ? 'clash-left' : ''}>
          ...
          />
          <text x="22" y="26" fill="white" fontSize="14" fontWeight="bold" fontFamily="system-ui">
            V
          </text>
        </g>
        ...
        <g className={animated ? 'clash-right' : ''}>
          ...
          />
          <text x="46" y="60" fill="white" fontSize="14" fontWeight="bold" fontFamily="system-ui">
            E
          </text>
        </g>
  ...
  return (
    ...
    >
      ...
      <g stroke="url(#minimalGradient)" strokeWidth="6" strokeLinecap="round" fill="none">
        ...
        {/* Arrow */}
        <path
          d="M52 40 L66 40 M58 32 L66 40 L58 48"
          className={animated ? 'draw-line' : ''}
...
export function LogoCompact({ size = 32, className = '' }: LogoProps) {
  return (
    ...
    >
      ...
      />
      <path d="M34 8 L44 8 L26 40 L16 40 Z" fill="#0ea5e9" />
      <path d="M36 20 L44 24 L36 28 L36 25 L32 25 L32 23 L36 23 Z" fill="white" />
    </svg>
  );
}
